...
- **expo-iap** - In-app purchases with weekly/yearly subscriptions (StoreKit 2 + Play Billing 8.x)
...
```bash
npx skills add emrahyurttutan/skills
```
...
3. **Monetization**: expo-iap + AdMob integration
